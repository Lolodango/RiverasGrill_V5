...
import com.Riveras.dao.FacturaDao;
import com.Riveras.dao.VentaDao;
import com.Riveras.domain.Producto;
import com.Riveras.domain.Usuario;
import com.Riveras.domain.Factura;
import com.Riveras.domain.Item;
import com.Riveras.domain.Venta;
import com.Riveras.service.UsuarioService;
import com.Riveras.service.ItemService;
...
import com.Riveras.dao.ProductoDao;
...
//Busca si ya existe el producto en el carrito
            if (Objects.equals(i.getIdProducto(), item.getIdProducto())) {
                ...
                if (i.getCantidad() < item.getExistencias()) {
                    //Incrementa en 1 la cantidad de elemento s
